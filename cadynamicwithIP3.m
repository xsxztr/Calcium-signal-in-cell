function dYdt=cadynamicwithIP3(t,Y)
...
nJserca	= nVs*(Cnd^2/(Ks^2+Cnd^2))*(ATPc/(Ke+ATPc));
...
Jhleak	= q9*Vm+q10;
 ...
 %% ODEs 
dCdt = fc*(Jipr*(1-RS1) - Jserca*(1-RS1) + Jleak*(1-RS1) + Jncx*(1-RS2)/RV3 - Jmcu*(1-RS2)/RV3 + Jdiff);
dCnddt = fn*RV1*(nJipr*RS1 - nJserca*RS1 - Jdiff + nJleak*RS1 + nJncx*RS2/RV3 - nJmcu*RS2/RV3);
dCmdt = fm*(nJmcu*RS2 - nJncx*RS2 + Jmcu*(1-RS2) - Jncx*(1-RS2));
...
%% 
dYdt = [dCdt;dCnddt;dCmdt;dADPmdt;dADPcdt;dNADHmdt;dVmdt;dPdt;dPnddt;dh42dt;dnh42dt];
end