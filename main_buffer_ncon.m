...
Y0 = [C0;Cnd0;Cm0;ADPM0;ADPC0;NADPHM0;VM0;P0;P_MAM0;h420;nh420;Cer0;Xp0;Xpnd0];
% C0 = Y0(1);
% Cnd0 = Y0(2);
% Cm0 = Y0(3);
 %% 
[t, Y] = ode15s(@(t,Y)cadynamicwithIP3_buff_ncon(t,Y),[0,100],Y0);
C = Y(:,1);
Cnd = Y(:,2);
Cm = Y(:,3);
...
legend('[Ca^{2+}]_{cyto}','[Ca^{2+}]_{MAM}','[Ca^{2+}]_{mito}', '[Ca^{2+}]_{ER}')
% figure(3)
% plot(t,Y(:,2),'k')
% xlabel('Time')
